...
4. Wenn dieselbe Konsequenz über mehrere Pfade erreichbar ist, erstelle EINEN vollständigen Consequence-Knoten. Alle weiteren Vorkommen werden als consequence-ref mit NUR id und refId exportiert — keine kopierten Felder.
...
6. Wenn ein Input bei mehreren Conditions gebraucht wird, erstelle EINEN Input-Knoten. Alle weiteren Vorkommen als input-ref mit NUR id und refId.
