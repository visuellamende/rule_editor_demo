...
export const en: Record<TranslationKey, string> = {
  ...
  'help.knowledgeSourcesText': 'Nodes can be annotated with domain sources — laws, standards, internal policies. The binding level determines how strictly an AI agent must treat the rule.',
  'help.validation': 'Validation',
  'help.validationText': 'The editor checks the decision tree for completeness and shows warnings on affected nodes. Missing outputs, unreachable nodes and empty endpoints are detected automatically.',
  'help.promptTemplates': 'Prompt Templates',
  'help.promptTemplatesText': 'In the right panel under "Prompt Templates" you can copy a complete prompt — including schema explanation, JSON model and task description. Paste directly into Claude, ChatGPT or Ollama.',
